                                                            ...
                                                            rdc.data_id,
                                      										...
                                      										where rdc.rsf_pfcbl_id = ids.rsf_pfcbl_id
                                      										  and rdc.indicator_id = ind.indicator_id
                                      											and rdc.reporting_asof_date <= $3::date
                                      										order by 
                                      										  rc.is_reported_cohort = true desc,  -- 'first' implies first reported value and/or
                                      										                                      -- system generated values up until a user reports
                                      										                                      -- and therefore the 'first' value could change
                                      										                                      -- over time
