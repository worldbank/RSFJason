                                  ...
                                  status_message=function(...) {}) { 
  {
    ...
    repeat {
      ...
      #
        ...
        #if(any(required_calculations$calculate_indicator_id %in% c(43449))) { stop("Found!") }
        ...
        #if (current_calculate_asof_date != ymd('2025-06-30')) stop("Future date")
        ...
        #Create processing entry to avoid any infinite loops or excessive calculations due to errors that could come up.
        {
          ...
          if (any(processed_calculations$processed_times > 1)) {
            ...
            repeat_calcs <- processed_calculations[processed_times > 1,.(calculate_rsf_pfcbl_id,calculate_indicator_id,calculate_asof_date)
                                   ][required_calculations[,.(calculate_rsf_pfcbl_id,calculate_indicator_id,calculate_asof_date)],
